...
public class ProgramaNagusia {
    ...
    /**
     * Metodo honek kontaktuak, katalogoa eta erosketenZerrendaak
     * arraylistak hasieratzen ditu.
     */
    ...
    /** Azterketa orrian zehaztutako txostena inprimatzen du, 
     * arraylistetan dauzkagun datuak irakurriz.
     * 
     */
    ...
    public static void katalogoaInprimatu() {
        ...
        String strErosketa = ("\nEROSKETEN ZERRENDA\n===================================================================================\n");
        strErosketa = strErosketa + String.format("%-11s | %-5s |%-20s | %10s | %10s | %10s\n", "MOTA", "KODEA", "IZENA", "PREZIOA", "ARDURATSUA", "EROSITAKOAK");
        strErosketa = strErosketa + "===================================================================================\n";
        
        for (int i = 0; i < katalogoa.size(); i++){
            Produktua k = katalogoa.get(i);
            String a = "";
                if(k.isArduratsua()){
                    a = "BAI";
                }
            String n = k.getClass().getSimpleName();
                if(k.getClass().getSimpleName().equals("EtxetresnaElektrikoa")){
                    n = "Etxetresna";
                }
            strErosketa = strErosketa + String.format("%-11s | %-5s |%-20s | %10s | %10s | %10s\n", n, k.getStrKodea(), k.getIzena(), k.getPrezioa(), a, "");
        }
        
        System.out.print(strErosketa);
    }
