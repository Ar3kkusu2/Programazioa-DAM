...
public class ArithmeticTest {     // Save as "ArithmeticTest.java"
   public static void main(String[] args) {
      ...
      int sum, difference, product, quotient, remainder, sumPlus;  // Declare 5 int variables to hold results
   
      // Perform arithmetic Operations
      sum = number1 + number2;
      sumPlus= number1*31+number2*17;
      ...
      System.out.println("Sumplus = " + sumPlus);
